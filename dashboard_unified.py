...
'WARNING', 'OK'], label_visibility='visible')
  ...
  st.markdown("---")
  st.markdown('<div style="font-size:0.72rem;color:#9ca3af;line-height:1.6;">💡 Analysis assumes 90 days of InfluxDB 
data.<br>RUL projects when rolling median hits failure threshold.<br>Green = filter healthy. Yellow = plan replacement 
soon. Red = replace now.</div>', unsafe_allow_html=True)
