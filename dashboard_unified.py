...
<div style="margin-top: 6px;">Air Quality: <span style="background: {'#dcfce7' if result.get('air_quality') else '#f3f4f6'}; color: {'#166534' if result.get('air_quality') else '#6b7280'}; padding: 2px 8px; border-radius: 4px; font-weight:
600; font-size: 0.8rem;">{"✓ Available" if result.get('air_quality') else "✗ Unavailable"}</span></div>
</div>
</div>
...
<div style="margin-top: 8px; font-size: 0.85rem; color: #374151;">
<div>Fit Quality (R²): <strong style="font-size: 1.1em; color: #1a202c;">{result.get('r2', '?'):.3f}</strong> <span style="color: #6b7280;">({('Excellent' if float(result.get('r2', 0)) > 0.7 else 'Good' if float(result.get('r2', 0)) > 0.5 
else 'Fair' if float(result.get('r2', 0)) > 0.25 else 'Poor')})</span></div>
