...
0.08em; text-transform: uppercase; }
    ...
    [data-testid="stDataFrame"] table { background-color: #ffffff !important; border-collapse: collapse; }
    [data-testid="stDataFrame"] th { background-color: #f3f4f6 !important; color: #1a202c !important; border: 1px solid
 #d1d5db !important; padding: 12px !important; text-align: left; font-weight: 600; }
    [data-testid="stDataFrame"] td { background-color: #ffffff !important; color: #1a202c !important; border: 1px solid
 #d1d5db !important; padding: 12px !important; }
